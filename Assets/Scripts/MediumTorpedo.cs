...
class MediumTorpedo : Torpedo {
	public static readonly float mediumCooldown = 5f;
	...
	public GameObject L_empSplashObj;
	public GameObject R_empSplashObj;
	...
	void OnDestroy () {
		...
		if (curLoc.x > 0) {
			Instantiate (L_empSplashObj, new Vector3(3.487008f, curLoc.y, 0f), new Quaternion(0f, 0f, 0f, 0f));
		} 
		else {
			Instantiate (R_empSplashObj, new Vector3(-3.487008f, curLoc.y, 0f), new Quaternion(0f, 0f, 0f, 0f));
		}
	}
